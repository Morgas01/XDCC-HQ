(function(µ,SMOD,GMOD,HMOD,SC){
	...
	<label for="showConfig">&#128295;</label>\
	<input type="checkbox" id="showConfig">\
	<table>\
		...
		<tr><td>append</td><td><input name="appendCRC" type="checkbox"></td></tr>\
	</table>\
	';
	...
	domConfig.innerHTML=html;
	domConfig.lastElementChild.addEventListener("change",function(e)
	{
