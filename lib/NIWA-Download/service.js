    ...
    module.exports=function(options)
    {
    	...
    	var methods={
    		...
    		add:function(param)
    		{
    			...
    			.then(function(data)
    			{
    				var downloads=data.map(d=>new options.DBClassDictionary[d.objectType]().fromJSON(d));
    		...
    		delete:function(param)
    		{
    			...
    			.then(function(data)
    			{
    				var deletions=Object.keys(data)
    				.map(type=>dbConnector
    					.then(dbc=>dbc.delete(options.DBClassDictionary[type],{ID:data[type],state:SC.deletableStates})
    						.then(r=>[type,r],
    							e=>[type,SC.es(e)]
							)
						)
