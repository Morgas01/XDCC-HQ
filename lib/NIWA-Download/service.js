    		...
    		sort:function(param)
    		{
    			...
    			.then(function(data)
    			{
					...
					.then(function(items)
					{
						...
						{
							console.log("sort",index,sortItem.objectType,sortItem.ID);
							for(var i=0;i<sortingItems.length;i++)
							{
								console.log("try",index,sortingItems[i].objectType,sortingItems[i].ID);
								if(sortingItems[i].ID==sortItem.ID&&sortingItems[i].objectType===sortItem.objectType)
								{
									console.log("found",index,sortingItems[i].objectType,sortingItems[i].ID);
